...
-- 2. CONFIG PLATOBOOST
-- ==========================================
local service = 23045;  -- Service ID lu
local secret = "01c4cf31-c986-480a-a2ef-3af1f5e57140";  -- HMAC Secret lu
local useNonce = true; 

local onMessage = function(message) 
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Egg Hunter Key",
            Text = message,
            Duration = 3
        })
    end)
...
-- ==========================================
-- [PASTE SCRIPT ENGINE PLATOBOOST LU DI SINI]
-- Mulai dari tulisan:
-- local a=2^32;local b=a-1; ... (sampai fungsi getFlag)
-- PENTING: Jangan paste bagian UI/tombol bawaan Platoboost, cukup mesinnya aja!
-- ==========================================
...
ScreenGui.Name = "PremiumLoginUI"
ScreenGui.ResetOnSpawn = false
ScreenGui.IgnoreGuiInset = true 

-- Fallback Parenting (Kunci Anti-Crash)
local uiParent
...
Title.Text = "🔑 EGG HUNTER V8 - LOGIN"
...
KeyInput.PlaceholderText = "Paste Key lu di sini ngab..."
...
GetKeyBtn.MouseButton1Click:Connect(function()
    if copyLink then
        copyLink() 
        onMessage("Link udah di-copy! Paste di browser lu.")
    else
        onMessage("Engine Platoboost belom keload!")
    end
end)
...
VerifyBtn.MouseButton1Click:Connect(function()
    ...
    if verifyKey then
        ...
        if success then
            ...
            -- PANGGIL SCRIPT V8 OBFUSCATE LU
        ...
        onMessage("Engine Platoboost error!")
        VerifyBtn.Text = "VERIFY KEY"
    end
end)
