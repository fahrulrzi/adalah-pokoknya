local TargetGameID = 129827112113663 -- GANTI SAMA ID GAME TELUR LU!
...
-- GANTI PAKE DATA DARI AKUN PLATOBOOST LU:
local service = 23045;  -- Ganti service ID lu
local secret = "01c4cf31-c986-480a-a2ef-3af1f5e57140";  -- Ganti secret lu
local useNonce = true; 

-- Callback notifikasi pas login
...
--! configuration
local service = 23045;  -- your service id, this is used to identify your service.
local secret = "01c4cf31-c986-480a-a2ef-3af1f5e57140";  -- make sure to obfuscate this if you want to ensure security.
...
Title.Text = "🔑 EGG HUNTER V7 - LOGIN"
...
KeyInput.PlaceholderText = "Masukin Key di sini..."
...
GetKeyBtn.MouseButton1Click:Connect(function()
    copyLink() -- Fungsi bawaan PlatoBoost buat ngambil link iklan/key
    onMessage("Link Key udah di-copy! Paste di Google Chrome/Safari.")
end)
...
VerifyBtn.MouseButton1Click:Connect(function()
    ...
    local success = verifyKey(inputKey) -- Fungsi bawaan PlatoBoost buat ngecek Key
    ...
    if success then
        ...
        -- 🔥 PANGGIL SCRIPT UTAMA LU DI SINI 🔥
        -- Ganti link ini sama link Raw Github/Pastebin Script V7 lu yang udah di-obfuscate!
        loadstring(game:HttpGet("https://raw.githubusercontent.com/fahrulrzi/adalah-pokoknya/refs/heads/main/eggv2.lua"))()
        
    else
        VerifyBtn.Text = "VERIFY KEY"
        -- Notif error otomatis diurus sama fungsi onMessage dari PlatoBoost
    end
end)
