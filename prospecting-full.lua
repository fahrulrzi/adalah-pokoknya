...
SimpleUI.WindowControls = {
    ...
    Windows = {
        ...
        Icons = {
            Minimize = {
                Image = "rbxassetid://136825236896355",
...
SimpleUI.Themes = {
    KuliJawa = { 
        ...
        SecondaryHover = Color3.fromRGB(35, 35, 42),
        SecondaryActive = Color3.fromRGB(45, 45, 55),
        SecondaryPressed = Color3.fromRGB(20, 20, 25),
        Tertiary = Color3.fromRGB(30, 30, 35),
        TertiaryHover = Color3.fromRGB(0, 100, 100),
        TertiaryActive = Color3.fromRGB(0, 150, 150),
        TertiaryPressed = Color3.fromRGB(0, 80, 80),
        Quaternary = Color3.fromRGB(35, 35, 40),
        QuaternaryHover = Color3.fromRGB(45, 45, 50),
        Separator = Color3.fromRGB(0, 255, 255),
        SeparatorTransparency = 0.6, 
        BoxBackground = Color3.fromRGB(10, 10, 12),
        TextPrimary = Color3.fromRGB(255, 255, 255),
        TextSecondary = Color3.fromRGB(180, 180, 190),
        TextInactive = Color3.fromRGB(100, 100, 110),
        TextActive = Color3.fromRGB(0, 255, 255),
        Accent = Color3.fromRGB(0, 255, 255),
        TabAccent = Color3.fromRGB(0, 200, 200),
        TabIconActive = Color3.fromRGB(0, 255, 255),
        TabIconHover = Color3.fromRGB(255, 255, 255),
        TabIconInactive = Color3.fromRGB(100, 100, 110),
        FontPrimary = Enum.Font.GothamBold,
        FontSecondary = Enum.Font.GothamMedium,
        FontSizePrimary = 18,
        FontSizeSecondary = 16,
        TransparencyPrimary = 0.0,
        TransparencySecondary = 0.2,
        TransparencyTertiary = 0.1
    }
}
...
local window = SimpleUI:CreateWindow({
    ...
    FooterItems = {{
        Type = "Text",
        Text = "KuliJawa Maker v" .. SimpleUI.Version .. " | Made by KuliJawa Maker",
        ColorTier = "TextSecondary",
        Order = 1
    }},
    StartHidden = false,
...
local Tabs = {
    Profile = SimpleUI:CreateTab(window, "Main", {
    ...
    Main = SimpleUI:CreateTab(window, "AutoFarming", {
...
local function initializeProfileTab()
    ...
    -- 4. MASTER LOOP BUAT TIMER BERJALAN
    task.spawn(function()
        while task.wait(1) do
            -- Hitung waktu bermain (Session)
            ...
            -- Hitung sisa waktu Key
            local remaining = keyExpiryTime - os.time()
            if remaining <= 0 then
                remaining = 0
                -- Di sini lu bisa nambahin fungsi game.Players.LocalPlayer:Kick("Key Expired!") 
            end
